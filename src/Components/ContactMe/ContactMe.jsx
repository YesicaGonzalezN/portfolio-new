        ...
        <div className="contact-container">
            <div className="options-contact">
                <article className="option-contact">
                    ...
                    <a className="vinculo-red" href="mailto:yesicanicolegonzalez@gmail.com" target='_blank' rel="noreferrer">Envíame un correo</a>
                </article>
                <article className="option-contact">
                    <i class="fa-brands fa-linkedin"></i>
                    <h4>LinkedIn</h4>
                    <h5>Nicole González LinkedIn</h5>
                    <a className="vinculo-red" href="https://www.linkedin.com/in/yesica-nicole-gonzalez/" target='_blank' rel="noreferrer">Visita mi LinkedIn</a>
                </article>
                <article className="option-contact">
                    <i class="fa-brands fa-whatsapp"></i>
                    <h4>WhatsApp</h4>
                    <h5>+54 1123861609</h5>
                    <a className="vinculo-red" href="https://wa.me/qr/25Q4TPCE2PLLP1" target='_blank' rel="noreferrer">Escríbeme</a>
                </article>
            </div>
